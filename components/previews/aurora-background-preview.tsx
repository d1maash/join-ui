  ...
  return (
    <AuroraBackground className="w-full rounded-xl border border-border">
      <div className="flex flex-col items-center gap-3 px-6 py-16 text-center sm:py-24">
        <p className="rounded-full border border-border bg-card/70 px-3 py-1 font-mono text-[0.6875rem] tracking-wider text-muted-foreground uppercase backdrop-blur-sm">
          v2.4 · now in general availability
        </p>
        <h3 className="max-w-md text-2xl font-semibold tracking-tight text-balance sm:text-3xl">
